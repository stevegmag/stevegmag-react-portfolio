  ...
  return (
    <section className={styles.container}>
      <div className={styles.content}>
        ...
        I'm a full-stack developer with years of experience building sites and applications using: JavaScript (ES6+) | Modern JS Frameworks | Node.js | PHP | Python | Drupal | WordPress
        </p>
